...
# Generated by qmake (2.01a) (Qt 4.4.0) on: Mon Jun 23 13:21:08 2008
...
SOURCES       = jsonparser.cpp \
		...
		twitterjsonparser.cpp \
		panoramiojsonparser.cpp \
		imagebrowserimpl.cpp moc_mainWindowDerived.cpp \
		moc_twitterbackendinterface.cpp \
		moc_HttpDownloadManager.cpp \
		moc_HttpFetchFile.cpp \
		moc_mainwindowimpl.cpp \
		moc_imagebrowserimpl.cpp \
		qrc_images.cpp
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents jsonparser.h mainWindowDerived.h twitterbackendinterface.h blog/blog.h Http/CacheStoragePolicy.h Http/DiscCache.h Http/FileStoragePolicy.h Http/HttpDownloadManager.h Http/HttpFetchFile.h Http/StoragePolicy.h MainWindow/mainwindowimpl.h Ui/login.h Ui/mainWindow.h Ui/sendTwit.h Http/HttpDownloadManager.moc Http/HttpFetchFile.moc twitterjsonparser.h panoramiojsonparser.h datastructure.h imagebrowserimpl.h imageBrowser.h .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents images/images.qrc .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents jsonparser.cpp main.cpp mainWindowDerived.cpp twitterbackendinterface.cpp Http/CacheStoragePolicy.cpp Http/DiscCache.cpp Http/FileStoragePolicy.cpp Http/HttpDownloadManager.cpp Http/HttpFetchFile.cpp MainWindow/mainwindowimpl.cpp twitterjsonparser.cpp panoramiojsonparser.cpp imagebrowserimpl.cpp .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents Ui/login.ui Ui/mainWindow.ui Ui/sendTwit.ui .tmp/qttwitter1.0.0/ && (cd `dirname .tmp/qttwitter1.0.0` && $(TAR) qttwitter1.0.0.tar qttwitter1.0.0 && $(COMPRESS) qttwitter1.0.0.tar) && $(MOVE) `dirname .tmp/qttwitter1.0.0`/qttwitter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qttwitter1.0.0
...
compiler_moc_header_make_all: moc_mainWindowDerived.cpp moc_twitterbackendinterface.cpp moc_HttpDownloadManager.cpp moc_HttpFetchFile.cpp moc_mainwindowimpl.cpp moc_imagebrowserimpl.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_mainWindowDerived.cpp moc_twitterbackendinterface.cpp moc_HttpDownloadManager.cpp moc_HttpFetchFile.cpp moc_mainwindowimpl.cpp moc_imagebrowserimpl.cpp
...
moc_imagebrowserimpl.cpp: imagebrowserimpl.h
	/usr/bin/moc $(DEFINES) $(INCPATH) imagebrowserimpl.h -o moc_imagebrowserimpl.cpp
...
panoramiojsonparser.o: panoramiojsonparser.cpp panoramiojsonparser.h \
		jsonparser.h \
		datastructure.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o panoramiojsonparser.o panoramiojsonparser.cpp

imagebrowserimpl.o: imagebrowserimpl.cpp imagebrowserimpl.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o imagebrowserimpl.o imagebrowserimpl.cpp
...
moc_imagebrowserimpl.o: moc_imagebrowserimpl.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_imagebrowserimpl.o moc_imagebrowserimpl.cpp
