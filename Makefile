...
# Generated by qmake (2.01a) (Qt 4.4.0) on: Mon Jun 23 10:58:11 2008
...
SOURCES       = jsonparser.cpp \
		...
		panoramiojsonparser.cpp moc_mainWindowDerived.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents jsonparser.h mainWindowDerived.h twitterbackendinterface.h blog/blog.h Http/CacheStoragePolicy.h Http/DiscCache.h Http/FileStoragePolicy.h Http/HttpDownloadManager.h Http/HttpFetchFile.h Http/StoragePolicy.h MainWindow/mainwindowimpl.h Ui/login.h Ui/mainWindow.h Ui/sendTwit.h Http/HttpDownloadManager.moc Http/HttpFetchFile.moc twitterjsonparser.h panoramiojsonparser.h datastructure.h .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents images/images.qrc .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents jsonparser.cpp main.cpp mainWindowDerived.cpp twitterbackendinterface.cpp Http/CacheStoragePolicy.cpp Http/DiscCache.cpp Http/FileStoragePolicy.cpp Http/HttpDownloadManager.cpp Http/HttpFetchFile.cpp MainWindow/mainwindowimpl.cpp twitterjsonparser.cpp panoramiojsonparser.cpp .tmp/qttwitter1.0.0/ && $(COPY_FILE) --parents Ui/login.ui Ui/mainWindow.ui Ui/sendTwit.ui .tmp/qttwitter1.0.0/ && (cd `dirname .tmp/qttwitter1.0.0` && $(TAR) qttwitter1.0.0.tar qttwitter1.0.0 && $(COMPRESS) qttwitter1.0.0.tar) && $(MOVE) `dirname .tmp/qttwitter1.0.0`/qttwitter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qttwitter1.0.0
